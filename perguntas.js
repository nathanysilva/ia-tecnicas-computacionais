export const perguntas = [
    {
        enunciado: "O QUE VOCÉ ACHOU DO PASSEIO DE PARANAGUÁ",
        alternativas: [
            {
                texto: "FOI INCLIVEL!",
                afirmacao: [
                    "FOI CHATO .",
                    "FOI INCRIVEL MAS FALTOU COISAS."
                ],
                proxima: 1,
            },
            {
    ...
    {
        enunciado: "O QUE GOSTO DE TOMAR?",
        alternativas: [
            {
                texto: "ESTA CALOR E QUERO UMA BEBIDA PARA REFRESCA.",
                afirmacao: [
                    "CAFÉ.",
                    "AGUÁ.",
                    "SUCO DE MARAGUJA."
            ...
            {
                texto: "ROGER ESTA PRECISANDO DE ROUPAS NOVAS E ELE NAO ESTA COM DINHEIRO O QUE ELE PODE FAZER.",
                afirmacao: [
                  "DEVE TRABALHAR.",
                    "DEVE JUNTA O DINHEIRO.",
                    " NÃO DEVE COMPRA POS NÃO E NECESSIDADE."
                ],
                proxima: 4,
            },
        ]
    ...
    {
        enunciado: "O QUE AS IA PODE FACILITAR HOJE EM DIA?",
        alternativas: [
            {
